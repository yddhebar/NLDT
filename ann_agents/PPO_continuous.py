...
def main():
    ############## Hyperparameters ##############
    #env_name = 'LunarLanderContinuous-v2'#'CarFollowingContinuous'#"BipedalWalker-v2"
    ...
    update_timestep = 10000      # update policy every n timesteps
    ...
    env = CarFollowing_Continuos()#gym.make(env_name)
