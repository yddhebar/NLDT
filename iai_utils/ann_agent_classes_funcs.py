...
class DQN(object):
    def __init__(self,
        ...
        self.eval_net, self.target_net = Net(env=env), Net(env=env)
...
def compute_total_reward(ann_agent, env, max_iter = 1000):
    """
