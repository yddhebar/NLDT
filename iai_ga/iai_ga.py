...
from iai_ga.fine_tune_best_indv import fine_tune_best_indiv
...
def bilevel_ga(X_train, Y_train, params = Parameters(), data_weights = None):
    ...
    if global_params.a_max is None:
        params.a_max = params.n_var
    else:
        params.a_max = global_params.a_max
    params.abs_flag = 1
    ...
    print('best F_U: %.2e, best cons vio = %.2e'% (best_so_far.fitness_ul,
    ...
    for gen in range(params.max_gen):
        ...
        parent_pop = child_pop#merge_and_reduce_pop(parent_pop, child_pop)
    ...
    #..fine_tune_best_indiv...
    #best_so_far = fine_tune_best_indiv(params, best_so_far, X_train, Y_train, data_weights = None)
